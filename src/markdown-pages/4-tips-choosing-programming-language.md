...
If you genuinely need your app to be performant. I mean, if speed is supposed to be your #1 USP, not just because _"yeah, it has to be webscale because it might get tons of traffic a couple of years from now."_ Then, by all means, go with Go, Rust, or whatever performant tools you've got under your belt. Or if it's C++ because of points number 1,2, and 3, then that's great too!
